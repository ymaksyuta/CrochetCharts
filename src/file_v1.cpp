...
FileFactory::FileError File_v1::save(QDataStream *stream)
{
...
void File_v1::loadColors(QXmlStreamReader *stream)
{
...
void File_v1::saveCustomStitches(QXmlStreamWriter *stream)
{
...
bool File_v1::saveCharts(QXmlStreamWriter *stream)
{
...
void File_v1::saveColors(QXmlStreamWriter *stream)
{
